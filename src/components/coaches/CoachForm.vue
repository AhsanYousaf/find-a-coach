<template>
    <form @submit.prevent="submitForm">
        <div class="form-control" :class="{ invalid: !firstName.isValid }">
            ...
            <input type="text" id="firstname" v-model.trim="firstName.val" @blur="clearValidaity('firstName')" />
            <p v-if="!firstName.isValid">Firstname must not be empty</p>
        </div>
        <div class="form-control" :class="{ invalid: !lastName.isValid }">
            <label for="lastname">Lastname</label>
            <input type="text" id="lastname" v-model.trim="lastName.val" @blur="clearValidaity('lastName')" />
        ...
        <div class="form-control" :class="{ invalid: !areas.isValid }">
            ...
            <p v-if="!areas.isValid">Please atleast select one Expertise</p>
        </div>
